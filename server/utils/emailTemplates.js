export function generateVerificationOtpEmailTemplate(otpCode) {
  return `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #444; background-color: #222; border-radius: 8px;">
    ...
    <div style="text-align: center; margin: 20px 0;">
      <span style="display: inline-block; font-size: 24px; font-weight: bold; color: #000; padding: 10px 20px; background-color: #f1c40f; border-radius: 5px;">
        ${otpCode}
      </span>
    </div>
    ...
    <footer style="margin-top: 20px; text-align: center; font-size: 14px; color: #666; border-top: 1px solid #444; padding-top: 10px;">
      <p>Thank you,<br>My Library Team</p>
